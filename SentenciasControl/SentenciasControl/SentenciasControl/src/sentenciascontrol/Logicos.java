...
import abstraccion.Logico;

public class Logicos extends javax.swing.JInternalFrame {

  
    private Logico logic = new Logico();
    ...
    private void bVerificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar1ActionPerformed
       try{
            this.logic.setNum1(Double.parseDouble(this.tfNum1.getText()));
            this.logic.setNum2(Double.parseDouble(this.tfNum2.getText()));
       
            if(this.logic.verificarNumerosIguales() == true){
           JOptionPane.showMessageDialog(this, "Son iguales","Igualdad", JOptionPane.INFORMATION_MESSAGE);
            }
            else{
           JOptionPane.showMessageDialog(this, "Son diferentes","Igualdad", JOptionPane.INFORMATION_MESSAGE);
            }
       }
       catch(NumberFormatException ex){
           JOptionPane.showMessageDialog(this, "Debe ingresar dos números","Igualdad", JOptionPane.ERROR_MESSAGE);
       }
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        try{
            this.logic.setNum1(Double.parseDouble(this.tfNum3.getText()));
            this.logic.setNum2(Double.parseDouble(this.tfNum4.getText()));
            
            if(this.logic.mayorNumero()== true){
                JOptionPane.showMessageDialog(this,this.logic.getNum1()+" es mayor","Mayor que", JOptionPane.INFORMATION_MESSAGE);
            }
            else{
                JOptionPane.showMessageDialog(this,this.logic.getNum2()+" es mayor","Mayor que", JOptionPane.INFORMATION_MESSAGE);
            }
            }
        
        catch(NumberFormatException ex){
            JOptionPane.showMessageDialog(this,"Debe proporcionar dos números","Mayor que",JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void bCalcular3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular3ActionPerformed
        try{
            this.logic.setNum1(Double.parseDouble(this.tfNum5.getText()));
            this.logic.setNum2(Double.parseDouble(this.tfNum6.getText()));
       
            if(this.logic.menorNumero()== true){
                JOptionPane.showMessageDialog(this,this.logic.getNum1()+" es menor","Menor que", JOptionPane.INFORMATION_MESSAGE);
            }
            else{
                JOptionPane.showMessageDialog(this,this.logic.getNum2()+" es menor","Menor que", JOptionPane.INFORMATION_MESSAGE);
            }
       }
       catch(NumberFormatException ex){
           JOptionPane.showMessageDialog(this, "Debe ingresar únicamente números","Menor que", JOptionPane.ERROR_MESSAGE);
       }
    ...
    private void bCalcular4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular4ActionPerformed
       try{
            this.logic.setNum1(Double.parseDouble(this.tfNum7.getText()));
            this.logic.setNum2(Double.parseDouble(this.tfNum8.getText()));
       
            if(this.logic.mayorOIgual() == true){
                JOptionPane.showMessageDialog(this,"Es verdad","Mayor o Igual", JOptionPane.INFORMATION_MESSAGE);
            }
            else{
                JOptionPane.showMessageDialog(this,"Es mentira","Mayor o Igual", JOptionPane.INFORMATION_MESSAGE);
            }
       }
       catch(NumberFormatException ex){
           JOptionPane.showMessageDialog(this, "Debe ingresar únicamente números","Menor que", JOptionPane.ERROR_MESSAGE);
    ...
    private void bVerificar6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar6ActionPerformed
         try{
            ...
            String s = this.tfCaracter1.getText();
            String r = this.tfCaracter2.getText();
            
            c1= s.charAt(0);
            c2= r.charAt(0);
            
            this.logic.setChar1(c1);
            this.logic.setChar2(c2);
            
            if(this.logic.caracteresIguales() == true){
                JOptionPane.showMessageDialog(this,"Son iguales","Caracteres", JOptionPane.INFORMATION_MESSAGE);       
            }
            else{
                JOptionPane.showMessageDialog(this,"No son iguales","Caracteres", JOptionPane.INFORMATION_MESSAGE);       
            }
         }
         catch(StringIndexOutOfBoundsException ex){
            JOptionPane.showMessageDialog(this, "Debe ingresar 2 letras","Caracteres", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void bVerificar7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar7ActionPerformed
        try{
            char c3, c4;
            String a = this.tfCaracter3.getText();
            String b = this.tfCaracter4.getText();
            
            c3= a.charAt(0);
            c4= b.charAt(0);
            
            this.logic.setChar1(c3);
            this.logic.setChar2(c4);
            
            if(this.logic.caracteresDiferentes() == true){
                JOptionPane.showMessageDialog(this,"Son diferentes","Caracteres", JOptionPane.INFORMATION_MESSAGE);       
            }
            else{
                JOptionPane.showMessageDialog(this,"No son diferentes","Caracteres", JOptionPane.INFORMATION_MESSAGE);       
            }
       }
        catch(StringIndexOutOfBoundsException ex){
            JOptionPane.showMessageDialog(this, "Debe ingresar 2 letras","Caracteres", JOptionPane.ERROR_MESSAGE);
    ...
    private void bVerificar8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar8ActionPerformed
            ...
            this.logic.setCad1(this.tfCadena1.getText());
            this.logic.setCad2(this.tfCadena2.getText());
            
            if(this.logic.igualarCadenas() == true){
               JOptionPane.showMessageDialog(this,"Las cadenas son iguales","Cadenas", JOptionPane.INFORMATION_MESSAGE);        
            }
            else{
                JOptionPane.showMessageDialog(this,"Las cadenas son diferentes","Cadenas", JOptionPane.INFORMATION_MESSAGE);        
            }
    ...
    private void bCalcular9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular9ActionPerformed
        ...
        this.logic.setCad1(this.tfCadena3.getText());
        this.logic.setCad2(this.tfCadena4.getText());
        
        String cadena3 = this.tfCadena3.getText() ;
        String cadena4 = this.tfCadena4.getText() ;
        
        if(this.logic.longitudCadenas()==true){
            
             JOptionPane.showMessageDialog(this, "( "+cadena4+" )"+ " es de mayor longitud o igual con respecto a "+ "( "+cadena3 +" )","Cadenas",
                   JOptionPane.INFORMATION_MESSAGE);
        }
        else{
            JOptionPane.showMessageDialog(this, "( "+cadena3+" )"+ " es de menor longitud con respecto a "+ "( "+cadena4 +" )","Cadenas",
                   JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void bVerificar10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar10ActionPerformed
        try{
            this.logic.setNum1(Double.parseDouble(this.tfNum11.getText()));
            
            if(this.logic.negativoOPositivo() == true){
                JOptionPane.showMessageDialog(this, this.tfNum11.getText() + " es negativo","Positivo o Negativo",
                   JOptionPane.INFORMATION_MESSAGE);
            }
            else{
                JOptionPane.showMessageDialog(this, this.tfNum11.getText() + " es positivo","Positivo o Negativo",
                   JOptionPane.INFORMATION_MESSAGE);
            }
        }
        
        catch(NumberFormatException ex){
            JOptionPane.showMessageDialog(this,"Debe proporcionar un números","Ejercicio 1",JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void bCalcular5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular5ActionPerformed
        try{
            this.logic.setNum1(Double.parseDouble(this.tfNum9.getText()));
            this.logic.setNum2(Double.parseDouble(this.tfNum10.getText()));
       
            if(this.logic.menorOIgual()== true){
                JOptionPane.showMessageDialog(this,"Es verdad","Mayor o Igual", JOptionPane.INFORMATION_MESSAGE);
            }
            else{
                JOptionPane.showMessageDialog(this,"Es mentira","Mayor o Igual", JOptionPane.INFORMATION_MESSAGE);
